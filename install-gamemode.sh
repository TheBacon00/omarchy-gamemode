...
echo "    o.bind(\"SUPER + ALT + G\", \"Enter Game Mode\", \"omarchy-launch-floating-terminal-with-presentation omarchy-steamos-session-interactive\")"
echo ""
echo "How it works:"
echo "  1. Super+Alt+G → omarchy-launch-floating-terminal-with-presentation omarchy-steamos-session-interactive"
