...
- **Gamescope Session:** Handled by systemd user units (`gamescope-session.target`, `steam-launcher.service`). Gamescope runs outside of standard window managers (DRM mode).
